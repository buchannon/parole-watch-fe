...
The UI is a static build served from the Namecheap `public_html/` directory next to the
Passenger/Django app. See [`.opencode/commands/parole-watch-ui-deploy.md`](./.opencode/commands/parole-watch-ui-deploy.md)
